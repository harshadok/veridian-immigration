...
export default function StatsStrip() {
  return (
    <section className="relative -mt-14 z-20 container-x">
      <div className="bg-white rounded-3xl shadow-2xl shadow-brand-900/10 grid grid-cols-2 md:grid-cols-4 divide-x divide-brand-50 overflow-hidden border-2 border-gold-400/20">
        {STATS.map((s) => (
